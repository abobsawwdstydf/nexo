            ...
            <div className="p-3">
              ...
              <div className="flex items-center gap-2 mb-3">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, var(--color-accent, #7B61FF) ${progress}%, rgba(255,255,255,0.1) ${progress}%)`,
                    }}
                  />
                </div>
              ...
              <div className="flex items-center gap-2 mt-2.5">
                ...
                <input
                  ...
                  style={{
                    background: `linear-gradient(to right, var(--color-accent, #7B61FF) ${volume * 100}%, rgba(255,255,255,0.1) ${volume * 100}%)`,
                  }}
                />
              </div>
            </div>
