        ...
        <div className="p-6 space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-12 h-6 rounded-full ${muted ? 'bg-red-500' : 'bg-zinc-700'}`}
            >
              <motion.span
                animate={{ x: muted ? 24 : 2 }}
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-12 h-6 rounded-full ${soundEnabled ? 'bg-indigo-500' : 'bg-zinc-700'}`}
            >
              <motion.span
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-12 h-6 rounded-full ${vibrateEnabled ? 'bg-indigo-500' : 'bg-zinc-700'}`}
            >
              <motion.span
                animate={{ x: vibrateEnabled ? 24 : 2 }}
                transition={{ type: 'spring', stiffness: 500, damping: 30 }}
                className="absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white"
              />
            </button>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-12 h-6 rounded-full ${showPreview ? 'bg-indigo-500' : 'bg-zinc-700'}`}
            >
              <motion.span
                animate={{ x: showPreview ? 24 : 2 }}
                transition={{ type: 'spring', stiffness: 500, damping: 30 }}
                className="absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white"
              />
            </button>
