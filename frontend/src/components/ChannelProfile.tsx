  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed inset-0 sm:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-[420px] sm:max-w-[calc(100vw-48px)] sm:h-[80vh] sm:max-h-[720px] sm:rounded-[2rem] bg-surface-secondary/90 backdrop-blur-3xl shadow-2xl border-0 sm:border sm:border-white/10 z-50 flex flex-col overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="flex flex-col items-center py-8 px-6">
            <div className="relative">
              ...
              <div className="relative z-10 p-1.5 rounded-full border border-white/10 shadow-2xl group">
                {channel.avatar ? (
          ...
          <div className="px-4 pb-4 space-y-3">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-surface-tertiary/50 border border-border">
              <div className="w-10 h-10 rounded-lg bg-nexo-500/20 flex items-center justify-center flex-shrink-0">
                <Calendar size={18} className="text-nexo-400" />
              </div>
              <div className="flex-1">
