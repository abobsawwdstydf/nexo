          ...
          <div className="flex-1 relative">
            {onAttach && (
              <motion.button
                whileTap={{ scale: 0.9 }}
                onClick={onAttach}
                className="absolute left-2.5 bottom-2 z-10 flex items-center justify-center w-7 h-7 rounded-full hover:bg-white/10 transition-colors"
              >
                <Paperclip size={18} className="text-white/40 rotate-[-45deg]" />
              </motion.button>
            )}
            <textarea
              ref={textareaRef}
              ...
              rows={1}
              className={`w-full resize-none bg-white/[0.06] border border-white/[0.06] rounded-2xl py-2 text-[15px] text-white placeholder:text-white/30 focus:outline-none focus:border-[var(--color-accent)]/40 focus:bg-white/[0.08] transition-all leading-[1.35] ${onAttach ? 'pl-10' : 'pl-3.5'} pr-10`}
            ...
            {!hasText && (
              <motion.button
                ...
                className="absolute right-2.5 bottom-2 z-10 flex items-center justify-center w-7 h-7 rounded-full hover:bg-white/10 transition-colors"
              >
