      ...
      {open && (
        ...
        >
          <motion.div
            ...
            aria-modal="true"
            aria-label={title}
            className="w-full max-w-[400px] rounded-2xl liquid-glass border border-white/[0.1] shadow-2xl overflow-hidden pointer-events-auto"
          >
            ...
            <div className="flex border-t border-white/5">
              ...
              <button
                ...
                className={`flex-1 py-3 text-sm font-medium transition-colors pointer-events-auto cursor-pointer ${
                  danger
                    ? 'text-red-400 hover:bg-red-500/10 hover:text-red-300'
                    : 'text-accent hover:bg-accent/10'
                }`}
