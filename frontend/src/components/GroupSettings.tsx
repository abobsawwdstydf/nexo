  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed inset-0 sm:inset-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-[420px] sm:max-w-[calc(100vw-48px)] sm:h-[80vh] sm:max-h-[720px] sm:rounded-[2rem] bg-surface-secondary/90 backdrop-blur-3xl shadow-2xl shadow-black/80 border-0 sm:border sm:border-white/10 z-50 flex flex-col overflow-hidden ring-0 sm:ring-1 sm:ring-white/10"
      >
        {/* Header */}
